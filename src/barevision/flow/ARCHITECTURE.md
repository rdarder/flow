...
```bash
python -m barevision.flow.train --model.num-levels 2 --dataset.img-size 384 512 --training.epochs 50
```
...
- **Testing**: Run smoke test after architectural changes: `python -m barevision.flow.train --smoke-test`
